...
void Insert_Staff() {      // 직원 추가 함수
	...
	gotoxy(pos_start.X - strlen("* 직원 추가 *") / 2, pos_start.Y - 12);
	printf("* 직원 추가 *");
...
void Delete_Staff() {      // 직원 삭제 함수
	...
	gotoxy(pos_start.X - strlen("* 직원 삭제 *") / 2, pos_start.Y - 12);
	printf("* 직원 삭제 *");
...
void Change_Staff() {      // 직원 수정 함수
	...
	gotoxy(pos_start.X - strlen("* 직원 수정 *") / 2, pos_start.Y - 12);
	printf("* 직원 수정 *");
	gotoxy(pos_start.X - 15, pos_start.Y - 1);
	printf("수정할 직원의 이름 : ");
	gotoxy(pos_start.X + 6, pos_start.Y - 1);
...
void Retrieve_Staff() {      // 직원 검색 함수
	...
	gotoxy(pos_start.X - strlen("* 직원 검색 *") / 2, pos_start.Y - 12);
	printf("* 직원 검색 *");
	gotoxy(pos_start.X - 15, pos_start.Y - 1);
	printf("검색할 직원의 이름 : ");
	gotoxy(pos_start.X + 6, pos_start.Y - 1);
